package com.backend.app.usuario.model;
...
import com.backend.app.archivosParaRevisar.SyncEntity;
...
public class User extends SyncEntity {
    ...
    @Column(length = 32)
    private String mfaSecret; // Secret key para Google Authenticator / TOTP
