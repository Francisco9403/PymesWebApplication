            ...
            <table className="w-full text-sm text-left">
              ...
              {currentData.products.map((p, i) => (
                  ...
                  >
                    ...
                    {/* PRECIO CON ALERTA DE VARIACIÓN (SCRUM-9) */}
                    <td className="p-4">
                          ...
                          <span className="text-[9px] text-slate-400 font-bold uppercase tracking-tighter">
                            Prev: ${p.lastCostPrice.toFixed(2)}
                              ...
                              {(() => {
                                ...
                                if (percent > 0.1) {
                                  return <span className="text-[10px] font-black text-red-500 flex items-center">
                                <span className="mr-0.5">↑</span>{percent.toFixed(1)}%
                              </span>;
                                }
                                if (percent < -0.1) {
                                  return <span className="text-[10px] font-black text-emerald-500 flex items-center">
                                <span className="mr-0.5">↓</span>{Math.abs(percent).toFixed(1)}%
                              </span>;
                                }
                                return <span className="text-[10px] font-bold text-slate-400 tracking-tighter ml-1 italic">
                              Sin cambios
                            </span>;
                              })()}
                            </div>
