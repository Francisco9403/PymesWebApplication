        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <header className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-3xl font-black text-slate-900 mt-2">Punto de Venta</h1>
              <p className="text-slate-500 text-sm">Escaneá productos y generá el cobro al instante.</p>
            </div>
