    ...
    <div className="card-container p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="btn-primary py-3 bg-indigo-600! hover:bg-indigo-700!"
        >
          Activar Cámara
        </button>
        <button
          onClick={() => setScanning(false)}
          className="px-4 py-3 border border-slate-200 rounded-xl font-bold text-slate-600 hover:bg-slate-50 transition-all active:scale-95"
        >
          Detener
        </button>
      </div>
