...
export default function AddStockForm({
  ...
  return (
    <form
      action={action}
      className="card-container p-6 animate-in fade-in slide-in-from-top-4 duration-500"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        <div className="md:col-span-2 space-y-1">
          ...
          <select
            name="productId"
            required
            className="w-full p-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500/20 outline-none font-bold text-slate-900 bg-white"
          >
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            placeholder="0"
            required
            className="w-full p-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-indigo-500/20 outline-none font-black"
          />
        </div>
