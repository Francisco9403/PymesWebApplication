    ...
    >
      ...
      {scanning && (
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none"
            style={{ border: "2px solid rgba(255,107,53,0.3)", borderRadius: "inherit" }} />
        </div>
      )}
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-sm
            ...
            hover:bg-[#FF8555] hover:-translate-y-[1px] hover:shadow-[0_8px_20px_rgba(255,107,53,0.3)]"
        >
      ...
      >
        ...
        <input
          ...
          className="px-4 py-3 rounded-xl text-sm outline-none transition-all border bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 font-medium focus:border-[rgba(255,107,53,0.5)] focus:ring-2 focus:ring-[rgba(255,107,53,0.12)] focus:bg-white dark:bg-[rgba(255,255,255,0.04)] dark:border-[rgba(255,255,255,0.08)] dark:text-[#F0EDE8] dark:placeholder:text-[#444] dark:focus:border-[rgba(255,107,53,0.5)] dark:focus:ring-[rgba(255,107,53,0.1)] dark:focus:bg-[rgba(255,255,255,0.06)] flex-1 font-bold"
        />
 
        {/* Add button */}
        <button
          onClick={() => { onScan(sku, quantity); setSku(""); setQuantity(1); }}
