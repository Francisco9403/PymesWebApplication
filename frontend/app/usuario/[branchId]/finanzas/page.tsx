        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {currencies.map((currency) => (
            ...
            >
              ...
              <p className={`text-4xl font-extrabold tracking-[-0.04em] ${currency.color}`}>
                <span className="text-lg mr-1 opacity-60">$</span>
                {Number(currency.value).toFixed(2)}
              </p>
 
              {/* Progress bar */}
              <div className="h-0.5 w-full rounded-full mt-5 overflow-hidden
                ...
                <div
                  ...
                  style={{ width: "100%", background: currency.color?.includes("#") ? currency.color : "#FF6B35" }}
                />
              </div>
            </div>
          ))}
