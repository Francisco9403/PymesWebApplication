    ...
    >
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1">
          <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none text-slate-400 dark:text-[#555]"
        ...
        <div className="relative">
          <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none text-slate-400 dark:text-[#555]"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7H4M16 12H8M12 17H8" />
          </svg>
          <select
          ...
          >
            <option value="" className="text-black">Stock normal</option>
            <option value="true" className="text-black">Bajo stock</option>
          </select>
          <svg className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none text-slate-400 dark:text-[#555]"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative">
          ...
          >
            ...
            <option value="name,asc" className="text-black">Nombre ↑</option>
            <option value="name,desc" className="text-black">Nombre ↓</option>
            <option value="baseCostPrice,asc" className="text-black">Costo ↑</option>
            <option value="baseCostPrice,desc" className="text-black">Costo ↓</option>
          </select>
          <svg className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 pointer-events-none text-slate-400 dark:text-[#555]"
            fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M19 9l-7 7-7-7" />
