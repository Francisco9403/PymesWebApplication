            ...
            <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
                <table className="w-full text-sm">
                    ...
                    <tr>
                        ...
                        <th className="p-4 font-medium text-gray-600">Código de Barras</th>
                        <th className="p-4 font-medium text-gray-600">Cantidad Disponible</th>
                    ...
                    {stockList?.map((stock) => {
                        // Lógica visual para las Alertas de Stock Crítico
                        ...
                        return (
                            <tr key={stock.id} className="border-t hover:bg-gray-50 transition-colors">
                                ...
                                <td className="p-4 text-gray-600">{stock.product.ean13 || "-"}</td>
