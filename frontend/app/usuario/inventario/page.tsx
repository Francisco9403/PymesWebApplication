        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              ...
              <h1 className="text-4xl font-black text-slate-900 tracking-tight">Control de Inventario</h1>
              <p className="text-slate-500 text-sm font-medium">
                Gestionando existencias en: <span className="text-indigo-600 font-bold">{activeBranch.name}</span>
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-2">
              <h2 className="text-lg font-bold text-slate-800 uppercase tracking-tight">Existencias Actuales</h2>
