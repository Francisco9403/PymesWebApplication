        ...
        <main className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6">
            ...
            <span className="relative flex h-2 w-2">
              ...
              <span className="relative h-2 w-2 rounded-full bg-green-500"></span>
                        ...
                        <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">Sistema Activo v1.0</span>
                    </div>
                    ...
                    <p className="text-lg text-slate-600 max-w-lg mx-auto leading-relaxed">
                        Gestión inteligente de inventario, ventas y finanzas diseñada para el crecimiento de tu negocio.
                    </p>
                </div>

                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <Link href="/iniciar-sesion" className="btn-primary text-center px-10 py-4 text-lg shadow-xl shadow-indigo-200/50">
                        Ingresar al Sistema
                    </Link>
                </div>
                ...
                <footer className="pt-12">
                    <p className="text-slate-400 text-sm font-medium">
                        Desarrollado con precisión en <span className="text-slate-600">Junín, Buenos Aires</span>
                    </p>
                </footer>
            </div>
        </main>
